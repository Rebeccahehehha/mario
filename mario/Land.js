...
function playerStuff(player, scoreLabel) {
...
scene('game', () => {
  const gameLevel = createGameLevel();
  scoreLabel = createScoreLabel();
  player = add([sprite('mario'), pos(30, 0), body(), area(), big()]);
  playerStuff(player, scoreLabel);
});
